...
**source for much of the text/code : https://github.com/rfordatascience/tidytuesday/blob/master/data/2023/2023-01-31/readme.md**
...
Intermediate users can try creating a `treemap` of the data.
