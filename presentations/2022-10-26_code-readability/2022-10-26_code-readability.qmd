...
# Presentation title {data-background-color="#FFCD00"}

![](templates/UU_logo_2021_EN_RGB.png){.absolute bottom=320 left=-240 width="300" height="120"}

# {data-background-color="#FFCD00"}

![](templates/UU_logo_2021_EN_RGB.png){.absolute bottom=-100 left=-240 width="300" height="120"}
...
:::
::: {.column width="60%"}
![](image.jpg){fig-align="right" width="300"}
:::
::::::::::::::
